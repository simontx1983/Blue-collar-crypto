...
| `bcc_trust_endorsement_fraud_analyze` (`EndorsementFraudAnalyzer::HOOK`) | [EndorsementFraudAnalyzer.php:42](../app/public/wp-content/plugins/bcc-trust/app/Domain/Core/Services/EndorsementFraudAnalyzer.php#L42) | Async endorsement fraud analysis after the endorsement transaction commits. |
| `bcc_trust_vote_fraud_analyze` (`VoteFraudAnalyzer::HOOK`) | [VoteFraudAnalyzer.php:51](../app/public/wp-content/plugins/bcc-trust/app/Domain/Core/Services/Vote/VoteFraudAnalyzer.php#L51) | Async vote fraud analysis after the vote transaction commits. |
